                        ...
                        {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                            ...
                            return (
                                <div key={idx} 
                                    ...
                                    onClick={() => {
                                        // 📍 ตรวจสอบการล็อกอินอย่างปลอดภัย ถ้าไม่ได้ล็อกอินให้แจ้งเตือน
...
const App = () => {
    ...
    // 📍 ประกาศ State ควบคุมคู่มือการใช้งาน 4 ส่วน
    ...
    // 📍 1. หน้าจอ Login พร้อมคู่มือ (ล็อค 100% หน้าจอ และแก้ไขให้สมัคร/ลืมรหัสได้เอง)
    if (!user) {
        return (
    ...
    return (
        <div className="app-container">
            ...
            {/* 📍 แถบเมนูด้านล่าง (Bottom Nav) ถูกนำสไตล์ล็อคออกให้ยึดติดล่างเสมอ ไม่มีการเลื่อนหนี/ซ่อนอัตโนมัติ */}
