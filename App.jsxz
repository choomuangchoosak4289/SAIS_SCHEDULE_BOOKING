                        ...
                        <div className="bg-slate-800 text-white p-4 rounded-xl mb-4 shadow-md text-xs leading-relaxed animate-pop relative">
                            ...
                            {user?.role === 'inspector' ? (
                                <ul className="list-disc pl-4 space-y-1.5 text-slate-200">
                                    <li><b>⏳ คิวรอตรวจ:</b> แสดงคิวงานที่ถูกจองชื่อคุณไว้ แต่แอดมินยังตรวจเอกสาร (Layout/Wiring/Precheck) ไม่ครบ 100%[span_0](start_span)[span_0](end_span)</li>
                                    <li><b>✅ เอกสารครบแล้ว:</b> งานที่พร้อมดำเนินการ (แอดมินยืนยันเอกสารครบแล้ว)[span_1](start_span)[span_1](end_span)</li>
                                    <li><b>🌴 วันลาของฉัน:</b> จัดการวันหยุดพักผ่อน, ลาป่วย, ลากิจ ของคุณได้เองที่แท็บนี้[span_2](start_span)[span_2](end_span)</li>
                                </ul>
                            ) : (
                                <ul className="list-disc pl-4 space-y-1.5 text-slate-200">
                                    <li><b>⏳ รอดำเนินการ:</b> คิวงานที่คุณกดจองไว้ และระบบกำลังรอให้ Admin ทำการตรวจสอบเอกสารแนบของคุณ[span_3](start_span)[span_3](end_span)</li>
                                    <li><b>✅ อนุมัติแล้ว:</b> คิวงานที่ Admin ตรวจตรวจสอบเอกสารครบถ้วนแล้ว (คิวสมบูรณ์)[span_4](start_span)[span_4](end_span)</li>
                                    <li><b>แก้ไข/ยกเลิก:</b> กดปุ่มจุดสามจุด (⋮) มุมขวาบนของการ์ด เพื่อแก้ไขรายละเอียด หรือยกเลิกคิวงาน <span className="text-red-400">(เฉพาะคิวที่ยังไม่ถึงวันตรวจจริง)</span>[span_5](start_span)[span_5](end_span)</li>
                                </ul>
                            )}
                        </div>
                    )}
                            ...
                            <div className="space-y-3 text-sm text-slate-700 mb-6">
                                ...
                                {!String(modal.data.job_type).includes('leave') && !String(modal.data.job_type).includes('event') && !String(modal.data.job_type).includes('holiday') && (
                                    <>
                                        ...
                                        {/* 📍 ปรับสถานะเป็น ตรวจสอบแล้ว / รอตรวจสอบ */}
