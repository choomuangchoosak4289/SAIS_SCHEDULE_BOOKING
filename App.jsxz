...
// 📍 CalendarGrid กลับมาใช้โค้ดจาก 17App แบบสมบูรณ์ เพื่อให้กดช่องในตารางได้
...
const App = () => {
    ...
    // 📍 ฟังก์ชัน apiAction เวอร์ชันเก่า สำหรับยิงไป Google Sheets API โดยตรง
        ...
        <div className="app-container">
            ...
            {successModal && (
                <div className="fixed inset-0 z-[700] flex items-center justify-center pointer-events-none p-4">
                    <div className="bg-white w-full max-w-[320px] rounded-3xl p-6 text-center shadow-2xl animate-pop border-4 border-green-400">
            ...
            {currentView === 'admin' && isAdmin && (
                <div className="page-view relative pb-20">
                    ...
                    {/* เมนูจัดการวันกิจกรรม วันลา วันหยุด (ใช้ apiAction 100%) */}
            ...
            {modal && (
                <div className="backdrop z-[100] p-4 flex items-center justify-center">
                    ...
                    {/* Modal จัดการวันลา วันหยุด กิจกรรม (แบบเก่า apiAction 100%) */}
                    {modal?.type === 'manage_leaves' && (
                        <div className="modal-card w-full max-w-md rounded-3xl overflow-hidden shadow-2xl animate-pop flex flex-col max-h-[90vh] bg-white">
                            ...
                            <div className="p-4 overflow-y-auto custom-scrollbar flex-1 bg-slate-50 space-y-4">
                                ...
                                {/* 📍 แสดง List และฟังก์ชันลบแบบกลุ่ม */}
                                            ...
                                            <div key={ge.id} className="flex items-center gap-3 bg-white p-3 rounded-xl border border-slate-200 shadow-sm hover:border-emerald-300 transition-all">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="font-bold text-slate-800 text-sm truncate">{ge.site_name} 
                                                        <span className="text-[9px] text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded-md ml-2 border border-emerald-100">ทุกคน</span>
                                                    </div>
