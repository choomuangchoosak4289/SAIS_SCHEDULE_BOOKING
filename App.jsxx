                            ...
                            return (
                                <div key={idx} 
                                    ...
                                    onClick={() => {
                                        ...
                                        // 📍 แก้บัคหน้าจอค้าง: ถอด State ภายนอกที่ไม่เกี่ยวกับ Grid ออก ส่งต่อเฉพาะข้อมูลที่ถูกต้อง
                                        if (isAdmin) {
...
const App = () => {
    ...
    // 📍 2. โหลด Firebase Compat แบบ 100% (รวม Storage สำหรับอัปโหลดไฟล์)
    useEffect(() => {
    ...
    // 📍 ฟังก์ชันบันทึกประวัติการทำงานลง Firebase (แทนที่ Google Sheets)
    ...
    useEffect(() => {
        if (successModal) {
            // ปรับระยะเวลา Pop-up ให้แสดงนานขึ้นนิดหน่อย (3.5 วิ) เพื่อให้อ่านรายละเอียดทัน
        ...
        setConfirmDialog({
            ...
            onConfirm: async () => {
                ...
                try {
                    ...
                    // 📍 Popup แจ้งรายละเอียดความสำเร็จ
                    setSuccessModal(
    ...
    const handleTouchEnd = async () => {
        // ระบบ Pull-to-refresh ดึงข้อมูลผ่าน Firebase ทันที ไม่ต้องรอ API
    ...
    return (
        <div className="app-container">
            ...
            {/* 📍 Overlay แจ้งเตือนสถานะต่างๆ (อัปเกรดให้รองรับข้อมูลรายละเอียดใน Pop-up) */}
            {successModal && (
                <div className="fixed inset-0 z-[700] flex items-center justify-center pointer-events-none p-4">
                    <div className="bg-white w-full max-w-[320px] rounded-3xl p-6 shadow-2xl animate-pop border-4 border-green-400">
                        ...
                        {typeof successModal === 'string' ? (
                            ...
                            successModal // เรนเดอร์ Element HTML ที่ส่งเข้ามาได้เลย
                        )}
                    </div>
                </div>
            )}
