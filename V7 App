...
const App = () => {
    ...
    useEffect(() => {
        ...
        const scheduleNextFetch = () => {
            ...
            // 🛠 แก้ไขจุดที่ 4.1: เพิ่มรอบระยะเวลาเป็น 5 นาที เพื่อลดปัญหาโควตาเต็ม
    ...
    // 🛠 แก้ไขจุดที่ 4.2: แนบ API KEY ทุกการอัปเดตข้อมูลเพื่อผ่าน Security
    ...
    const handleBookingSubmit = async (e) => {
        ...
        // 🛠 แก้ไขจุดที่ 4.3: เปลี่ยนสถานะเริ่มต้นของเอกสารจาก false เป็น pending เพื่อง่ายต่อการตรวจสอบของแอดมิน
        if (!modal?.data?.id) {
                ...
                <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 relative overflow-hidden flex flex-col max-h-[90vh]">
                    ...
                    {showLoginHelp ? (
                        ...
                        <form onSubmit={async (e) => {
                            ...
                            // 🛠 แก้ไขจุดที่ 4.4: แนบ API KEY ทุกๆ Request จากหน้าล็อกอิน
                            if (isForgotMode) {
