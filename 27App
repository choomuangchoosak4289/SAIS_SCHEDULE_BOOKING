...
const App = () => {
    ...
    // 📍 ระบบ Pull-to-refresh (การประกาศตัวแปรเหล่านี้ต้องอยู่ก่อนถูกนำไปใช้ เพื่อไม่ให้เกิดจอดับ)
...
const App = () => {
    ...
    // 💡 availableInspectors (ป้องกันรายชื่อซ้ำและไม่ผูกไอดีตัวเอง)
    ...
    // 📍 การประกาศ State ส่วนที่เหลือทั้งหมด (ป้องกัน ReferenceError หน้าเว็บดับ 100%)
    ...
    // 📍 ฟังก์ชัน Touch ควบคุมการลากจอเพื่อ Refresh (แก้ ReferenceError: handleTouchStart is not defined)
    ...
    const handleTouchEnd = async () => {
        if (pullY > 50 && !isRefreshing) { 
            ...
            setPullY(50); 
            // 📍 ใช้ฟังก์ชัน fetchCoreData ที่ประกาศภายหลังได้เพราะตัว Closure จะจับผูกกันตอน Render
            if (typeof fetchCoreData === 'function') await fetchCoreData(); 
    ...
    // 📍 ระบบค้นหา ID ฉลาด (ป้องกัน Error หา ID ไม่เจอ)
    ...
    const handleFileUpload = async (e, docType, isMultiple = false) => {
        ...
        setLoadingMsg('กำลังบีบอัดรูปภาพและจัดเก็บ...'); 
        ...
        <div className="app-container">
            ...
            {modal && (
                <div className="backdrop z-[100] p-4 flex items-center justify-center">
                            ...
                            <form onSubmit={async (e) => {
                                ...
                                if (modal.isNew) {
                                    ...
                                    if (regOk) {
                                        ...
                                        if (typeof fetchAdminData === 'function') fetchAdminData(0, 50, 'users');
                                    }
                                } else {
                                    const payload = {
                    ...
                    {/* 📍 Modal แจ้งวันลา (เพิ่มคนหลายคนได้) */}
                                ...
                                <div className="bg-white p-4 rounded-xl shadow-sm border border-emerald-100">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <button onClick={async () => {
                                            ...
                                            setModal(null); // 📍 ปิดหน้าจอทันที ไม่ต้องรอ
