...
const App = () => {
    ...
    useEffect(() => {
        ...
        const scheduleNextFetch = () => {
            ...
            // 📍 แก้ไข: เพิ่มรอบเป็น 5 นาที (300000 ms) เพื่อลด Rate Limit
    ...
    // 📍 คืนค่าฟังก์ชันแอดมิน Checkbox แบบคลาสสิกที่สมบูรณ์
    ...
    return (
        <div className="app-container">
            ...
            {/* 📍 แถบเมนูด้านล่าง คืนค่า Layout เดิม ไม่ให้บังปุ่ม Logout หรือหน้า Admin */}
            ...
            {/* 📍 หน้าตรวจเอกสาร (Admin) คืนค่า Checkbox แบบเดิม 100% */}
                                                ...
                                                return (
                                                    <div key={docKey} className={`flex flex-col gap-1 items-center p-2 rounded-lg border ${isSent ? 'bg-green-50' : 'bg-slate-50'}`}>
                                                        ...
                                                        <label className="flex items-center gap-1 cursor-pointer">
                                                            {/* 📍 Checkbox แบบดั้งเดิมที่แอดมินใช้ติ๊กสถานะ */}
                    ...
                    <div className="space-y-3 pb-10">
                        {(() => {
                            ...
                            const filteredTasks = (db.bookings || []).filter(b => {
                                ...
                                const isPast = new Date(formatSafeDate(b.date)) < getThaiTime(); 
