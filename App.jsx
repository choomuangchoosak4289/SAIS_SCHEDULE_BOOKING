...
const App = () => {
    ...
    // 🛠️ ถอดการบังคับ .calendar-grid ออก ปล่อยให้ React จัดการ Grid เพื่อแก้ปัญหาตารางซ้อน
    const DynamicStyles = () => {
        const s = db.settings || {};
        return (
            <style>{`
    ...
    // 📍 กรองรายการแจ้งเตือนที่ "ยังไม่ได้อ่าน" แบบรายบุคคล
                            ...
                            <div className="overflow-y-auto flex-1 pr-2 space-y-3 custom-scrollbar">
                                {(() => {
                                    ...
                                    return filteredEvents.slice(0, logsLimit).map((ev, i) => {
                                        if (ev.type === 'notif') {
                                            // 📍 ตรวจสอบการอ่านแบบรายบุคคล ป้องกันบัค admin/admin1
