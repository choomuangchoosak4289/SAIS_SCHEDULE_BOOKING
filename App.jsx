                        ...
                        {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                            ...
                            return (
                                <div key={idx} 
                                    ...
                                    onClick={() => {
                                        // 📍 FIX BUG: เช็คการล็อกอินแบบปลอดภัย ไม่เรียกฟังก์ชันที่ไม่ได้ประกาศ
...
const App = () => {
    ...
    // 📍 1. ประกาศ State ควบคุมคู่มือการใช้งาน 4 ส่วน
    ...
    // 📍 ลบ useEffect สำหรับ isNavVisible และ Auto-Hide ออกแล้ว เพื่อให้เมนูด้านล่างล็อคตายตัว
    ...
    // 📍 หน้าจอ Login พร้อมคู่มือ (ล็อค 100% หน้าจอ)
    if (!user) {
        return (
