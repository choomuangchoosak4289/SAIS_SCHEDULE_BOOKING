...
const App = () => {
    ...
    // 📍 State สำหรับ Dashboard อัจฉริยะ (เพิ่มฟิลเตอร์)
    ...
    // 📍 1. แก้ไขลอจิกระบบแจ้งเตือน: กรองข้อมูลเฉพาะที่ยังไม่ได้อ่าน โดยอิงตาม username
    ...
    const handleTabChange = (view) => {
        setCurrentView(view);
        // 📍 ถ้าเข้าหน้า Admin, Search, หรือ Dashboard ให้โหลดข้อมูลสถิติทันที (ทุกคนเข้า Dashboard ได้)
    ...
    // 📍 1. เปิดให้ปุ่ม Logout ทำงานและแสดงผลสำหรับทุกคน
    const handleLogout = () => {
        setConfirmDialog({
    ...
    return (
        <div className="app-container">
            ...
            {/* 5. หน้าต่าง Dashboard วิเคราะห์ข้อมูลอัจฉริยะ (ดูได้ทุกคน) */}
                                                ...
                                                {sortedInspectors.map((ins, idx) => (
                                                    <div key={ins.name} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-100 hover:border-blue-200 transition-colors">
                                                        <div className="flex items-center gap-3">
                                                            <div className="w-8 h-8 rounded-full flex items-center justify-center font-black text-sm bg-indigo-100 text-indigo-600 border border-indigo-200">
                                                                {idx + 1}
                                                            </div>
