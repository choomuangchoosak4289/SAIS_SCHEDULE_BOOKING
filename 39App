                        ...
                        {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                            ...
                            return (
                                <div key={idx} 
                                    ...
                                    onClick={() => {
                                        // 📍 ป้องกันหน้าจอค้างด้วย try-catch 100%
                                        try {
