...
// 📍 แก้ไขบั๊ก CalendarGrid: นำทางและตรวจสอบการกดคลิกช่องตารางอย่างสมบูรณ์
                        ...
                        {!d.isEmpty && (db.inspectors || []).map((ins, idx) => {
                            ...
                            return (
                                <div key={idx} 
                                    ...
                                    onClick={() => {
                                        // 📍 FIX BUG: ตรวจสอบการเข้าสู่ระบบแบบปลอดภัย ไม่เรียกฟังก์ชันลอย
...
const App = () => {
    ...
    // 📍 FIX BUG: ประกาศ State ควบคุมคู่มือการใช้งาน 5 ส่วนครบถ้วนป้องกัน ReferenceError
    ...
    // 📍 ระบบล็อกอินแบบบล็อกเต็มหน้าจอ 100% ป้องกันข้อมูลรั่วไหล
    if (!user) {
        return (
    ...
    return (
        <div className="app-container">
            ...
            {/* 2. หน้าตรวจเอกสาร (Admin) กู้คืน Checkbox แบบเดิม 100% */}
